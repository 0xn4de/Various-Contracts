...
- [WannaBet](./src/Jan01_WannaBet.sol)
...
- [BullToken](./src/Jan02_BullToken.sol)
...
- [FreeForAll](./src/Jan03_FreeForAll.sol)
...
- [FreeForAllToken](./src/Jan04_FreeForAllToken.sol)
  ...
  - startTime is at the same time every day, but if no transfers happen in the 23 hours beforehand, `transferFrom` will need to be called (with a legitimate transfer)
- [FreeForAll1155](./src/Jan05_FreeForAll1155.sol)
...
- [ERC1155Vault](./src/Jan06_ERC1155Vault.sol)
...
- [NFTMarket](./src/Jan08_NFTMarket.sol)
...
- [WannaBetV2](./src/Jan09_WannaBetV2.sol)
...
- [WannaBetFactory](./src/Jan10_WannaBetFactory.sol)
...
- [NFTAuction](./src/Jan11_NFTAuction.sol)
...
- [Crowdfund](./src/Jan13_Crowdfund.sol)
...
- [Prediction](./src/Jan14_Prediction.sol)
...
- [LockerToken](./src/Jan31_LockerToken.sol)
