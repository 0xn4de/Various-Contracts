...
lastUpdated: public(uint256)
minPrice: public(int256)
...
@external
def __init__(_name: String[32], _symbol: String[32], _decimals: uint8, _supply: uint256, _priceFeed: address):
...
def transfer(_to : address, _value : uint256) -> bool:
    ...
    if block.timestamp > self.lastUpdated + 604800:
        self.minPrice = price
        self.lastUpdated = block.timestamp
    assert price >= self.minPrice, "Price is too low"
